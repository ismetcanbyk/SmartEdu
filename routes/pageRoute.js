...
router.route('/')
    .get(pagerController.getIndexPage);

router.route('/about')
    .get(pagerController.getAboutPage);

router.route('/register')
    .get(redirectMidlleware, pagerController.getRegisterPage);

router.route('/login')
    .get(redirectMidlleware, pagerController.getLoginPage);
